...
public class Setting {
	...
	public static void main(String[] args) {
		...
		try {
			...
			var con2 = DriverManager.getConnection("jdbc:mysql://localhost/2022_ex03_2?serverTimezone=UTC&allowLoadLocalInfile=true", "root", DB_PWD);
...
//			stmt.execute("GRANT SELECT, INSERT, UPDATE, DELETE ON 2022_ex03_2.* TO 'user'@'localhost'");	
			BaseFrame.imsg("셋팅성공");
