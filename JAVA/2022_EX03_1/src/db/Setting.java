...
public class Setting {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// DB 존재시 제거
			stmt.execute("DROP SCHEMA IF EXISTS `2022_ex03_1`");
			// DB 생성
			stmt.execute("CREATE SCHEMA `2022_ex03_1` DEFAULT CHARACTER SET utf8 ;");
			
			// 테이블 생성
			stmt.execute("CREATE TABLE `2022_ex03_1`.`company` (\r\n"
			...
			stmt.execute("CREATE TABLE `2022_ex03_1`.`user` (\r\n"
			...
			stmt.execute("CREATE TABLE `2022_ex03_1`.`employment` (\r\n"
			...
			stmt.execute("CREATE TABLE `2022_ex03_1`.`applicant` (\r\n"
			...
			var con2 = DriverManager.getConnection("jdbc:mysql://localhost/2022_ex03_1?serverTimezone=UTC&allowLoadLocalInfile=true", "root", DB_PWD);
			...
			stmt.execute("GRANT SELECT, INSERT, UPDATE, DELETE ON 2022_ex03_1.* TO 'user'@'localhost'");	
